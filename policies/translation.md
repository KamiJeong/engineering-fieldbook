...
학습 문서는 제목과 본문뿐 아니라 학습 목표, 선수 지식, 101·201·301의 범위, 예제 가정·수치, 질문의 해설도 대조한다. 한국어 합니다체를 영어에서 반복적인 “we will”로 옮기지 않고 정의는 직접 설명하며 활동은 독자가 수행할 동작으로 쓴다. 원문의 가능성·예외·권고를 보장으로 강화하지 않는다. 언어별 index와 사이트 운영 안내도 전수 번역 검토의 대상이며, concept_id가 없는 문서의 검토 결과는 log에 기록한다.
